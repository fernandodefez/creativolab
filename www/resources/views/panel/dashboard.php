...
<head>
    ...
    <link href="/assets/product-tour/lib.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="/assets/core/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="/assets/core/js/demo/chart-area-demo.js"></script>
