                        ...
                        <form>
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-9">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" placeholder="Título">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-8">
                                    <label for="inputCity">Institución</label>
                                ...
                                <div class="form-group col-md-2">
                                    <label for="inputState">Culminación</label>
                                    <select id="inputState" class="form-control custom-select ">
                                        <option selected>Año</option>
                                        <option> ... </option>
                                    </select>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Detalles de estancia</label>
                                <textarea class="form-control"
                                          placeholder="Detalles de estancia"
