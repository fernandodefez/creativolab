...
<head>
    ...
    <title>My Porto CV - Creativo Lab</title>

    <!-- css include -->
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/materialize.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/owl.theme.default.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/animate.css">

    <!-- my css include -->
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/reset.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/style.css">
    <link rel="stylesheet" type="text/css" href="/assets/templates/executive/css/responsive.css">
...
<div class="fixed-left-side-body">
    <div class="profile">
        <div class="profile-image center-align">
            <img src="/assets/templates/executive/images/perfil.jpg" alt="Image">
        </div>
        <!-- /.profile-image -->

        <div class="profile-name center-align">
            <h1 class="user-name">Sara Miller</h1>
            <p>
                <span class="photoshop-color">Diseñadora Grafica</span>
            </p>
        </div>
        <!-- /.profile-name -->
        ...
        <div class="discription clearfix">
            <h2 class="title mb-30">Que hay en mi mente</h2>
            <p>
                Podemos desarrollar y diseñar cualquier cosa más allá de su imaginación. Sobre nuestro trabajo, no decimos nada porque nuestro trabajo habla. Para más información, puede preguntar a nuestros clientes y ellos le dirán cuán satisfechos están con nuestros servicios. ¿Entonces, Qué esperas?
            </p>
        </div>
        <!-- /.discription -->
        <!--
                    <div class="cv-btn">
                        <a href="#!" class="custom-btn waves-effect waves-light">
                            <i class="fa fa-download" aria-hidden="true"></i> Descargar CV
                        </a>
                    </div>
        -->
    </div>
...
<div class="right-side-body">
                ...
                <div class="nav-wrapper main-nav-wrapper">
                        ...
                        <ul class="ul-li-block side-nav" id="mobile-demo">
                            ...
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/1" class="waves-effect">
                                    <i class="fa fa-user-o" aria-hidden="true"></i> Acerca de mi
                                </a>
                            </li>
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/2" class="waves-effect">
                                    <i class="fa fa-lightbulb-o" aria-hidden="true"></i> Habilidades
                                </a>
                            </li>
                            <li class="sn-item">
                            ...
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/4" class="waves-effect">
                                    <i class="fa fa-briefcase" aria-hidden="true"></i> Portafolio
                                </a>
                            </li>
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/5" class="waves-effect">
                                    <i class="fa fa-quote-left" aria-hidden="true"></i> Testimoniales
                                </a>
                            </li>
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/6" class="waves-effect">
                                    <i class="fa fa-pencil" aria-hidden="true"></i> Experiencia
                                </a>
                            </li>
                            <!--
                                                            <li class="sn-item">
                            ...
                            <li class="sn-item">
                                <a href="http://webstrot.com/html/myporto/light_version/8" class="waves-effect">
                                    <i class="fa fa-envelope-o" aria-hidden="true"></i> Contactame
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="hello_main_navigation hello_single_index_menu2">
                        <ul id="nav-mobile" class="right main-nav-ul">
                            <li class="active"><a href="http://webstrot.com/html/myporto/light_version/0" class="nav-mobile">Inicio</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/1" class="waves-effect default">Acerca de mi</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/2" class="waves-effect default">Habilidades</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/3" class="waves-effect default">Educación</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/4" class="waves-effect default">Portafolios</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/5" class="waves-effect default">Testimoniales</a></li>
                            <li><a href="http://webstrot.com/html/myporto/light_version/6" class="waves-effect default">Experiencia</a></li>
                            <!--                                <li><a href="http://webstrot.com/html/myporto/light_version/7" class="waves-effect default">blog</a></li>-->
                            <li><a href="http://webstrot.com/html/myporto/light_version/8" class="waves-effect default">Contactame</a></li>
                            <!--
                                                            <li>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="hello_logo_wrapper">
                                    <div class="hello_logo">
                                        <img src="/assets/templates/executive/images/logo.png" alt="hello_logo">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                <div class="hello_fixed_nav_wrapper hello_single_index_menu3">
                                    <ul class="hello_nav_fixed">
                                        ...
                                        <li><a href="http://webstrot.com/html/myporto/light_version/2" class="waves-effect default">Habilidades</a></li>
                                        <li><a href="http://webstrot.com/html/myporto/light_version/3" class="waves-effect default">Educación</a></li>
                                        <li><a href="http://webstrot.com/html/myporto/light_version/4" class="waves-effect default">Portafolio</a></li>
                                        <li><a href="http://webstrot.com/html/myporto/light_version/5" class="waves-effect default">Testimoniales</a></li>
                                        <li><a href="http://webstrot.com/html/myporto/light_version/6" class="waves-effect default">Experiencia</a></li>
                                        <!--                                            <li><a href="http://webstrot.com/html/myporto/light_version/7" class="waves-effect default">blog</a></li>-->
    ...
    <section id="main-slider-section" class="main-slider-section mb-30 clearfix">
        ...
        <div class="main-slider owl-carousel owl-theme">
                ...
                <div class="row">
                    ...
                    <div class="col l6 m6">
                        <div class="item-child-left left-align">
                            <h2 class="hi">Hola.</h2>
                            <p class="name">Mi nombre es Sara Miller</p>
                            <small class="position mb-30">& Soy absolutamente adicta al diseño</small>

                            <a href="#!" class="custom-btn waves-effect waves-light">
                                <i class="fa fa-picture-o" aria-hidden="true"></i> Mira mi portafolio
                            </a>
                        </div>
                        <!-- /.item-child-left -->
                    </div>
            ...
            <!--
                                    <div class="col l6 m6">
                                        <div class="item-child-right right-align">
                                            <img src="assets/images/perfil.jpg" alt="Image">
                                            <a href="#" class="chat waves-effect waves-light">
                                                <i class="fa fa-commenting-o" aria-hidden="true"></i>
                                            </a>
                                        </div>
    ...
    <div data-scroll='1' class="aboutme-section sec-p100-bg-bs mb-30 clearfix" id="about">
        <div class="Section-title">
            ...
            <span>about me</span>
            <p>
                Hola, soy Sara Miller Creative Graphic Designer & User Experience Desiger basado en el sitio web, creo productos digitales en un lugar más hermoso y utilizable. Esta es la versión de Photoshop de Lorem Ipsum. Proin gravida nibh vel velit quet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulpuate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt
                .
            </p>
        </div>
        <!-- /.Section-title -->
        ...
        <div class="portfolio-area">
            ...
            <div class="grid">
                <div class="element-item transition metal" data-category="transition">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-1.jpg" alt="Image">
                        <a href="#" class="more">
                ...
                <div class="element-item metalloid" data-category="metalloid">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-2.jpg" alt="Image">
                        <a href="#" class="more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>
                    </div>
                ...
                <div class="element-item post-transition metal" data-category="post-transition">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-3.jpg" alt="Image">
                        <a href="#" class="more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>
                    </div>
                ...
                <div class="element-item post-transition metal" data-category="post-transition">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-4.jpg" alt="Image">
                        <a href="#" class="more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>
                    </div>
                ...
                <div class="element-item transition metal" data-category="transition">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-5.jpg" alt="Image">
                        <a href="#" class="more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>
                    </div>
                ...
                <div class="element-item alkali metal" data-category="alkali">
                    <div class="ei-child">
                        <img src="/assets/templates/executive/images/portfolio/img-6.jpg" alt="Image">
                        <a href="#" class="more">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>
                    </div>
    ...
    <div data-scroll='5' class="testomonials-section sec-p100-bg-bs mb-30 clearfix" id="testimonial">
            ...
            <div id="testomonial-carousel" class="owl-carousel owl-theme">
                <div class="item">
                    ...
                    <div class="testomonial-img">
                        <img src="/assets/templates/executive/images/testomonial/testomonial-img1.jpg" alt="Image">
                    </div>
                    <!-- /.testomonial-img -->
                ...
                <div class="item">
                    <div class="testomonial-img">
                        <img src="/assets/templates/executive/images/testomonial/testomonial-img2.jpg" alt="Image">
                    </div>
                    <!-- /.testomonial-img -->
                ...
                <div class="item">
                    <div class="testomonial-img">
                        <img src="/assets/templates/executive/images/testomonial/testomonial-img3.jpg" alt="Image">
                    </div>
                    <!-- /.testomonial-img -->
                ...
                <div class="item">
                    <div class="testomonial-img">
                        <img src="/assets/templates/executive/images/testomonial/testomonial-img4.jpg" alt="Image">
                    </div>
                    <!-- /.testomonial-img -->
                ...
                <div class="item">
                    <div class="testomonial-img">
                        <img src="/assets/templates/executive/images/testomonial/testomonial-img5.jpg" alt="Image">
                    </div>
                    <!-- /.testomonial-img -->
        ...
        <ul class="brand-list ul-li">
            <li>
                <a href="#!">
                    <img src="/assets/templates/executive/images/brand/brand1.png" alt="Brand Image">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="/assets/templates/executive/images/brand/brand2.png" alt="Brand Image">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="/assets/templates/executive/images/brand/brand3.png" alt="Brand Image">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="/assets/templates/executive/images/brand/brand4.png" alt="Brand Image">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="/assets/templates/executive/images/brand/brand5.png" alt="Brand Image">
                </a>
            </li>
        </ul>
    ...
    <div data-scroll='7' class="latest-news-section sec-p100-bg-bs mb-30 clearfix" id="blog">
        ...
        <div class="news-item clearfix">
            <div class="news-image b4-1 left">
                <img src="/assets/templates/executive/images/news/news1.jpg" alt="Image">
            </div>
            <!-- /.news-image -->
        ...
        <div class="news-item clearfix">
            <div class="news-image b4-1 left">
                <img src="/assets/templates/executive/images/news/news3.jpg" alt="Image">
            </div>
            <!-- /.news-image -->
            <div class="news-contant right left-align">
                <h2 class="title">Creative Deisng News</h2>
...
<script src="/assets/templates/executive/js/jquery-3.1.1.min.js"></script>
<script src="/assets/templates/executive/js/materialize.min.js"></script>
<script src="/assets/templates/executive/js/owl.carousel.min.js"></script>
<script src="/assets/templates/executive/js/isotope.pkgd.min.js"></script>
<script src="/assets/templates/executive/js/circle-progress.js"></script>

<!-- my custom js -->
<script src="/assets/templates/executive/js/custom.js"></script>
</body>
