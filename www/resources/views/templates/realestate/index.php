...
<head>
    ...
    <link href="/assets/templates/realestate/css/aos.css" rel="stylesheet">
    <link href="/assets/templates/realestate/css/bootstrap.min.css" rel="stylesheet">
    <link href="/assets/templates/realestate/styles/main.css" rel="stylesheet">
</head>
<body id="top">
<header>
...
<div class="page-content">
    <div>
                    ...
                    <div class="container">
                        <div class="content-center">
                            ...
                            <p class="category text-white">
                                <?php
                                    echo $data['profession']->getProfession();
                                ?>
                            </p>
                            <a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">
                                Hire Me
                            </a>
                            <a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">
                                Download CV
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-sm-8">
                                        <?php
                                            echo "+" . $data['user']->getCode() . " " . $data['user']->getPhoneNumber();
                                        ?>
                                    </div>
                                </div>
                                <div class="row mt-3">
                            ...
                            <div class="row p-3">
                                <img src="<?php echo "/storage/users/". $data['user']->getFolder() ."/". $data['user']->getQr(); ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/project-1.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/project-2.jpg" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/project-3.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/project-4.jpg" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/graphic-design-1.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/graphic-design-2.jpg" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/graphic-design-3.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/graphic-design-4.jpg" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/photography-1.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/photography-3.jpg" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/photography-2.jpg" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="/assets/templates/realestate/images/photography-4.jpg" alt="Image"/>
                                                <figcaption>
        ...
        <!-- Experience Begin -->
        <?php
        if (isset($data['experiences']) && !empty($data['experiences']) && $data['user']->areExperiencesEnabled()) {
        ?>
                    ...
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body cc-experience-header">
                                ...
                                <div class="h5"> <?php echo $experience->getCompany(); ?> </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="/assets/templates/realestate/images/reference-image-1.jpg" alt="Image"/>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="/assets/templates/realestate/images/reference-image-2.jpg" alt="Image"/>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="/assets/templates/realestate/images/reference-image-3.jpg" alt="Image"/>
...
<script src="/assets/templates/realestate/js/core/jquery.3.2.1.min.js"></script>
<script src="/assets/templates/realestate/js/core/popper.min.js"></script>
<script src="/assets/templates/realestate/js/core/bootstrap.min.js"></script>
<script src="/assets/templates/realestate/js/now-ui-kit.js?v=1.1.0"></script>
<script src="/assets/templates/realestate/js/aos.js"></script>
<script src="/assets/templates/realestate/scripts/main.js"></script>
</body>
</html>
