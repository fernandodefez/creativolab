...
<head>
    <title>
        Apex a Personal Category bootstrap Responsive website Template| Home :: w3layouts
    </title>
    <!--meta tags -->
    <meta charset="UTF-8">
    ...
    <!--booststrap-->
    <link href="/assets/templates/design/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
    <!--//booststrap end-->
    <!-- font-awesome icons -->
    <link href="/assets/templates/design/css/font-awesome.min.css" rel="stylesheet">
    <!-- //font-awesome icons -->
    <!--stylesheets-->
    <link href="/assets/templates/design/css/style.css" rel='stylesheet' type='text/css' media="all">
    <!--//stylesheets-->
            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 about-wthree-images">
                        <img src="/assets/templates/design/images/ab1.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 about-wthree-images">
                        <img src="/assets/templates/design/images/ab2.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 about-wthree-images">
                        <img src="/assets/templates/design/images/ab3.jpg" alt="news image" class="img-fluid">
                    </div>
                </div>
        ...
        <section class="gallery pt-lg-4 pt-md-3 pt-sm-3 pt-3" id="gallery">
            <div class="container pt-lg-5 pt-md-4 pt-sm-4 pt-3">
                ...
                <div class="row gallery-info">
                    <div class="col-lg-4 col-md-4 col-sm-4 gallery-img-grid p-0">
                        <div class="gallery-grids">
                            <a href="#gal1">
                                <img src="/assets/templates/design/images/g1.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 gallery-img-grid p-0">
                        <div class="gallery-grids">
                            <a href="#gal2">
                                <img src="/assets/templates/design/images/g2.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                        <div class="gallery-grids">
                            <a href="#gal3">
                                <img src="/assets/templates/design/images/g3.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 gallery-img-grid p-0">
                        <div class="gallery-grids">
                            <a href="#gal4">
                                <img src="/assets/templates/design/images/g4.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 gallery-img-grid p-0">
                        <div class="gallery-grids">
                            <a href="#gal5">
                                <img src="/assets/templates/design/images/g6.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 gallery-img-grid p-0">
                        <div class="gallery-grids">
                            <a href="#gal6">
                                <img src="/assets/templates/design/images/g5.jpg" alt="news image" class="img-fluid">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div id="gal1" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g1.jpg" alt="Popup Image" class="img-fluid" />
                ...
                <div id="gal2" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g2.jpg" alt="Popup Image" class="img-fluid" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div id="gal3" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g3.jpg" alt="Popup Image" class="img-fluid" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div id="gal4" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g4.jpg" alt="Popup Image" class="img-fluid" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div id="gal5" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g6.jpg" alt="Popup Image" class="img-fluid" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
                ...
                <div id="gal6" class="popup-effect">
                    <div class="popup">
                        <img src="/assets/templates/design/images/g5.jpg" alt="Popup Image" class="img-fluid" />
                        <a class="close" href="#gallery">&times;</a>
                    </div>
                </div>
                <!-- //popup -->
            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                ...
                <div class="row mt-lg-4 mt-3">
                    <div class="col-lg-6 col-md-6 col-sm-6 blog-two-two">
                        ...
                        <img src="/assets/templates/design/images/blog2.jpg" alt="news image" class="img-fluid">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 blog-two-two mt-3">
                        <img src="/assets/templates/design/images/blog1.jpg" alt="news image" class="img-fluid">
